...
\part{GENERAL INTRODUCTION} \cleardoublepage
...
\input{content/intro-5-problematic} \cleardoublepage

\part{METHODS} \cleardoublepage
\input{content/method-1-eeg} \cleardoublepage
\input{content/method-2-fMRI} \cleardoublepage

\part{EXPERIMENTAL RESULTS} \cleardoublepage
\input{content/results-1-arousal} \cleardoublepage

\part{GENERAL DISCUSSION} \cleardoublepage
