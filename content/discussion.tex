...
\begin{figure}[!htb]
	...
	\caption[Summary of the results on DRF]{Summary of the differences observed between high and low dream recallers. \emph{Top}. Psychological and cognitive variables. \emph{Middle}. Regional cerebral blood flow (rCBF) and functional connectivity. \emph{Bottom}. Sleep parameters and event-related potentials. The findings of the present thesis are written in bold.}
	\label{fig:disc:drf:summary}
\end{figure}

\subsection{Intra-sleep awakening duration is a critical factor to explain DRF variability}
...
\subsection{The brain functional connectivity at awakening predicts DRF}
...
\subsection{Higher creativity and default network functional connectivity in HR}
...
\section{A comprehensive model of dream recall}
...
The results of the present thesis led us to propose a comprehensive model of dream recall, depicted in Fig \ref{fig:disc:drf:model}.
