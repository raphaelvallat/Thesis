...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Fig/Introduction/Intro_Guenole/Intro_Guenole.png}
	\caption{Guénolé's model of dreaming}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Fig/Introduction/Intro_Sleep_Stages_PSD/Fig_Intro_Sleep_Stages_PSD_final_150517.png}
	\caption{Polysomnographic recordings across sleep and wakefulness. Top: Scalp EEG, EOG and EMG performed in one healthy young adult during wakefulness, N1, N2, N3 and REM sleep. The main features of each vigilance state are described. Bottom: Spectral properties of each stage obtained by computing the spectrogram of the Cz EEG signal atop.}
...
\begin{figure}[htb]
	\includegraphics[width=\textwidth]{Fig/Introduction/Intro_Hypnogram/Intro_Hypnogram.png}
...
\begin{table}[htb]
\caption{A brief description of sleep mentation in their typical order of placement during the sleep cycle. Modified from \citet{de_koninck_sleep_2012}}
