...
\cleanchapterquote{We must also inquire what the dream is, and from what cause sleepers sometimes dream, and sometimes do not; or whether the truth is that sleepers always dream but do not always remember (their dream); and if this occurs, what its explanation is.}{Aristotle}{On Sleep and Sleeplessness. 350 B.C.}
...
\begin{figure}[!htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{Fig/Intro/Intro_JBE_Paradigm/Intro_JBE_Paradigm.png}
...
\FloatBarrier % Force figures to be before new section
